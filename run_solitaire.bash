...
if [ $# -ne 3 ]; then
	echo "command requires 3 arguements: usage run_solitaitre.bash [max faces] [max suits] [trials]"
	exit 1
fi
intregex='^[0-9]+$'
if ! [[ $1 =~ $intregex ]] || ! [[ $2 =~ $intregex ]] || ! [[ $3 =~ $intregex ]]; then
	echo: "One of the arguements is not an integer: $1 $2 $3"
	exit 1
fi
if [ $1 -gt 15 ] || [ $2 -gt 8 ]; then
	echo "Limited to no more than 15 faces and 8 suits"
	exit 1
fi
if [ $3 -gt 100000 ]; then
